# Marquee · Pilot Batch 01 — Silent Era prompts

> **12 paste-ready generation prompts**, one per movie, for style **C · Silent Era (antique engraving)**.
...
> credits). Spec: `card-spec-C-silent-era.md` · shared rules: `card-template-contract.md`.
>
...
GENRE glyph — a diamond filled with muted deep red
(#7E3A34) over fine hatching. To its right, "GOODFELLAS" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1990" in smaller
...
A circular "Deep Cut" badge — muted verdigris (#6F8F8C) fill with hatched shading, ivory double ring, "Deep" in engraved script over "CUT" in small caps — sits inside the window near its bottom-right corner.

CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Robert De Niro (actor, slate circle) +1
Ray Liotta (actor, slate circle) +1
Martin Scorsese (director, brown square) +2
...
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a diamond filled with muted deep red
(#7E3A34) over fine hatching. To its right, "THE GODFATHER" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1972" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
FOUR plain scored rows — no boxes or capsules — top to bottom:
Marlon Brando (actor, slate circle) +1
Al Pacino (actor, slate circle) +1
James Caan (actor, slate circle) +1
Francis Ford Coppola (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a square filled with muted plum
(#5A5068) over fine hatching. To its right, "TAXI DRIVER" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1976" in smaller
sepia serif figures, right-aligned on the same line.
...
THREE plain scored rows — no boxes or capsules — top to bottom:
Robert De Niro (actor, slate circle) +1
Jodie Foster (actor, slate circle) +1
Martin Scorsese (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a triangle filled with muted navy
(#4A5A78) over fine hatching. To its right, "INCEPTION" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "2010" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Leonardo DiCaprio (actor, slate circle) +1
Joseph Gordon-Levitt (actor, slate circle) +1
Christopher Nolan (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a chevron filled with muted slate
(#5C6670) over fine hatching. To its right, "THE DARK KNIGHT" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "2008" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Christian Bale (actor, slate circle) +1
Heath Ledger (actor, slate circle) +1
Christopher Nolan (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a pentagon filled with muted jungle green
(#567553) over fine hatching. To its right, "JURASSIC PARK" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1993" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Sam Neill (actor, slate circle) +1
Laura Dern (actor, slate circle) +1
Steven Spielberg (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a heart filled with muted rose
(#B06A6A) over fine hatching. To its right, "TITANIC" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1997" in smaller
sepia serif figures, right-aligned on the same line.
...
THREE plain scored rows — no boxes or capsules — top to bottom:
Leonardo DiCaprio (actor, slate circle) +1
Kate Winslet (actor, slate circle) +1
James Cameron (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a star filled with muted teal
(#4E7F7C) over fine hatching. To its right, "CATCH ME IF YOU CAN" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "2002" in smaller
sepia serif figures, right-aligned on the same line.
...
THREE plain scored rows — no boxes or capsules — top to bottom:
Leonardo DiCaprio (actor, slate circle) +1
Tom Hanks (actor, slate circle) +1
Steven Spielberg (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a shield filled with muted sienna
(#855640) over fine hatching. To its right, "UNFORGIVEN" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1992" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Gene Hackman (actor, slate circle) +1
Morgan Freeman (actor, slate circle) +1
Clint Eastwood (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a hexagon filled with muted olive
(#6C6845) over fine hatching. To its right, "DUNKIRK" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "2017" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Fionn Whitehead (actor, slate circle) +1
Tom Hardy (actor, slate circle) +1
Christopher Nolan (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a circle filled with muted bronze
(#8A6A44) over fine hatching. To its right, "THE SHAWSHANK REDEMPTION" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1994" in smaller
sepia serif figures, right-aligned on the same line.
...
CREDITS (bottom block, aligned to the art window's edges):
THREE plain scored rows — no boxes or capsules — top to bottom:
Tim Robbins (actor, slate circle) +1
Morgan Freeman (actor, slate circle) +1
Frank Darabont (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
...
HEADER (inside the border, top):
At the top-left, an engraved double-line circular roundel containing only the
GENRE glyph — a rounded square filled with muted sky blue
(#5A7A96) over fine hatching. To its right, "TOY STORY" in large
ornate Victorian display-serif capitals in near-black sepia (#2A2118), readable
even when the card is overlapped in a fanned hand. The year "1995" in smaller
sepia serif figures, right-aligned on the same line.
...
THREE plain scored rows — no boxes or capsules — top to bottom:
Tom Hanks (actor, slate circle) +1
Tim Allen (actor, slate circle) +1
John Lasseter (director, brown square) +2
Each row: a small engraved role glyph on the left (actor = muted slate-blue
#6E8190 circle, director = muted brown #8A6A3C square), the name in a sturdy
old-style serif in sepia ink, and the point value in the same serif right-aligned
at the row's far right.
