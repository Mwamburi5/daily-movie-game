# Match Cut — four-mode smoke matrix (`prod`)
...
- **Run window (UTC)** — 2026-09-05T21:27:00.275Z → 2026-09-05T21:28:24.610Z
...
- **Load** — PASS — duel board rendered; hand 7 cards, marquee tops The Wolf of Wall Street / Avengers: Infinity War, score 0-0, turn playerTurn
- **Successful action** — PASS — played Moneyball onto the The Wolf of Wall Street marquee via Jonah Hill: accepted (score 0-0 → 1-0, hand 7 → 6, "CPU: drew a card")
- **Error recovery** — PASS — dropped Die Hard on the The Wolf of Wall Street marquee with no shared credit and no Final Cut: refused (hand still 7, score still 0-0, turn still playerTurn — the turn was not consumed); play continued
- **Terminal** — PASS — game reached its terminal screen after 100 driven steps. Dialog "Game over — results": CPU wins. | CPU hit 20 — the show goes to the higher net. | HIGHER IS BETTER | Net -5 vs 10 · played − held | You | 1 played − 6 held | -5 | CPU
- **Share copy** — button read `copied ✓`, captured via clipboard. Exact text:

```
Match Cut · Duel
lost vs Matinee · net -5 to 10
🎬🟥🟥🟥
```
- **Faults during this mode** — 0 console errors · 0 console warnings · 0 pageerrors · 0 CSP violations · 0 failed same-origin requests
