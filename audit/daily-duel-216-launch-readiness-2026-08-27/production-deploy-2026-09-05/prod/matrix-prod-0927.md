# Match Cut — four-mode smoke matrix (`prod-0927`)

- **Target** — https://matchcutdaily.com
...
- **Run window (UTC)** — 2026-09-05T21:29:02.602Z → 2026-09-05T21:30:15.026Z
...
- **Terminal** — PASS — Cleared. Result dialog "Cleared — results": Cleared! | Final score 0 | LOWER IS BETTER | Score 0 = 2 strokes − 2 credits | 2 strokes · 2 streak credits | DAY 86 · STREAK 1 · BEST 0
- **Share copy** — button read `copied ✓`, captured via clipboard. Exact text:
...
- **Load** — PASS — duel board rendered; hand 7 cards, marquee tops Ocean's Thirteen / Do the Right Thing, score 0-0, turn playerTurn
- **Successful action** — PASS (via Final Cut) — no printed link existed in the opening hand; armed Final Cut and played Titanic: accepted (score 0-0 → 1-1)
- **Error recovery** — PASS — dropped Looper on the Ocean's Thirteen marquee with no shared credit and no Final Cut: refused (hand still 7, score still 0-0, turn still playerTurn — the turn was not consumed); play continued
- **Terminal** — PASS — game reached its terminal screen after 86 driven steps. Dialog "Game over — results": CPU wins. | CPU hit 20 — the show goes to the higher net. | HIGHER IS BETTER | Net -5 vs 16 · played − held | You | 1 played − 6 held | -5 | CPU
- **Share copy** — button read `copied ✓`, captured via clipboard. Exact text:
