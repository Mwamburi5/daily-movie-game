// DIAGNOSTIC ONLY — scratchpad copy of scripts/verify-preview-security.mjs
// (repo gate untouched). The single difference: the browser context sends
// `x-vercel-skip-toolbar: 1`, the documented Vercel header that suppresses the
// Toolbar injection on authenticated Preview responses. Purpose: learn whether
// the Toolbar injection is the ONLY red in the real gate. Not a substitute for it.
import { readFileSync } from 'node:fs'
import { chromium } from '@playwright/test'
import { SECURITY_HEADERS } from '/Users/mwamburi/Projects/Daily Movie Game/security-headers.ts'
...
const context = await browser.newContext({
  ...
  extraHTTPHeaders: { 'x-vercel-skip-toolbar': '1' }, // DIAGNOSTIC-ONLY difference
...
try {
  ...
  console.log(`[DIAGNOSTIC, x-vercel-skip-toolbar:1] Preview security verified: ${previewOrigin}`)
